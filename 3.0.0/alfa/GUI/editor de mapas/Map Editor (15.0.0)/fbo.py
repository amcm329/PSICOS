...
class FBO2D:
    ...
    def attach_color_texture(self,texture,index):
        ...
        self.attach_attachment_texture(self.attachments_color[index])
    ...
    def attach_color_renderbuffer(self,precision,index):
        ...
        self.attach_attachment_renderbuffer(self.attachments_color[index])
    def attach_depth_renderbuffer(self,precision):
        self.attachments_depth = AttachmentRenderbufferDepthFBO(self.size,precision)
        self.attach_attachment_renderbuffer(self.attachments_depth)

    def attach_attachment_texture(self,attachment):
    ...
    def attach_attachment_renderbuffer(self,attachment):
        glBindFramebufferEXT(GL_FRAMEBUFFER,self.framebuffer_id)
