...
class Mapa:
	...
	############ACM-18-02-2013########################################################
        ...
        ############ACB-13-2-13########################################################
		#This method fills de neighbors list of each cell, it will be used in the lider_move method to fill the cell lists 
		#with a Moore neighborhood.
